...
The mathematical model is called a [Markov chain](https://en.wikipedia.org/wiki/Markov_chain). Actually used in science to predict/simulate future behavior based on past recordings.